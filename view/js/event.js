...
let regs = document.getElementById('reg')

function regClicked(){
    regs.style.cssText = 'background-color: #388E3C; color: white;'
}

function regUnclicked(){
    regs.style.cssText = 'background-color: #EDF8EB; color: #388E3C;'
}
